...
const styles = StyleSheet.create({
  ...
  pageTitle: { fontSize: 24, fontWeight: '500', color: '#0f172a', textAlign: 'center', marginBottom: 20 },
  resultCard: { backgroundColor: '#2563eb', borderRadius: 16, padding: 32, alignItems: 'center', marginBottom: 20 },   // --primary
  resultLabel: { color: '#ffffff', fontSize: 16, opacity: 0.9, marginBottom: 8 },
  resultMeal: { color: '#ffffff', fontSize: 28, fontWeight: '500', textAlign: 'center' },
  optionsIntro: { fontSize: 15, color: '#0f172a', textAlign: 'center', marginBottom: 16 },
  optionsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 24 },
  optionChip: { backgroundColor: '#ffffff', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 10, borderWidth: 1, borderColor: '#cbd5e1' },
  optionChipText: { color: '#0f172a', fontSize: 14, fontWeight: '500' },
  buttonRow: { flexDirection: 'row', justifyContent: 'center', marginTop: 8 },
  primaryBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#2563eb', borderRadius: 12, paddingHorizontal: 20, paddingVertical: 14, gap: 8, justifyContent: 'center' },  // --primary
  primaryBtnText: { color: '#ffffff', fontWeight: '500', fontSize: 15 },
  secondaryBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#e2e8f0', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, gap: 8 },  // --secondary
  secondaryBtnText: { color: '#0f172a', fontWeight: '500', fontSize: 15 },
  progressMeta: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  progressLabel: { fontSize: 13, color: '#64748b' },
  progressTrack: { height: 6, backgroundColor: '#e2e8f0', borderRadius: 999, marginBottom: 32, overflow: 'hidden' },  // --secondary
  progressFill: { height: 6, backgroundColor: '#2563eb', borderRadius: 999 },                                          // --primary
  question: { fontSize: 22, fontWeight: '500', color: '#0f172a', textAlign: 'center', marginBottom: 24 },
  optionsList: { gap: 12 },
  optionRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#ffffff', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 16, borderWidth: 1, borderColor: '#cbd5e1' },
