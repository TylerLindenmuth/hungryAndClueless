...
export default function Dashboard({ user, onLogout, onUpdateUser }: DashboardProps) {
  ...
  const { bg, card, text, muted, border, primary, secondary, toggleTheme, isDark } = useTheme();
      ...
      <SafeAreaView style={[styles.container]}>
        ...
        <View style={[styles.header, { backgroundColor: card, borderBottomColor: border }]}>
          <View style={styles.headerLeft}>
            <Text style={[styles.appTitle, { color: text }]}>
        ...
        <View style={[styles.tabBar, { backgroundColor: card, borderBottomColor: border }]}>
          <TouchableOpacity
            style={[
              ...
              activeTab === 'library' && { backgroundColor: primary },
            ]}
          ...
          >
            <Ionicons
              name="book-outline"
              size={18}
              color={activeTab === 'library' ? '#fff' : muted}
            />
            <Text
              style={[
                styles.tabText,
          ...
          <TouchableOpacity
            style={[
              styles.tab,
              { backgroundColor: secondary },
              activeTab === 'quiz' && { backgroundColor: primary },
            ]}
          ...
          >
            <Ionicons
              ...
              size={18}
              color={activeTab === 'quiz' ? '#fff' : muted}
            />
            <Text
              style={[
                styles.tabText,
